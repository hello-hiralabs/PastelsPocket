...
export const EN = {
  ...
  'Atur kategori tiap amplop':'Assign categories to envelopes',
  'Yang biasa kamu catat':'Your usual amounts',
  'Jatah hampir habis!':'Almost out of allowance!',
  'Yang masuk Jatah Jajan ikut menentukan limit harianmu.':'Whatever lands in Jajan Money shapes your daily limit.',
  'Kategori {0} pindah ke amplop {1}':'{0} moved to the {1} envelope',
  'Persen amplop lain ikut disesuaikan biar totalnya tetap 100%':'The other envelopes adjust so the total stays 100%',
  'Ganti sapaan':'Change greeting',
  /* --- alokasi celengan --- */
  'Alokasi amplop celengan bulan ini {0}':'This month’s savings envelope: {0}',
  'Belum disetor ke celengan: {0}':'Not yet deposited: {0}',
  'Setor Alokasi ke Celengan':'Move Allocation Into Funds',
  'Alokasi celengan sudah tersetor semua ✨':'The whole savings allocation is already in ✨',
  '{0} dibagi ke {1} celengan 💖':'{0} split across {1} funds 💖',
  'Belum ada celengan buat disetori':'No fund to deposit into yet',
  /* --- reset --- */
  'Reset Data':'Reset Data',
  'Mau reset yang mana? 🧹':'What should we reset? 🧹',
  'Pilih salah satu. Keduanya minta konfirmasi lagi sebelum jalan.':'Pick one. Both ask again before anything is erased.',
  'Reset Bulan Ini':'Reset This Month',
  'Hapus catatan jajan & amplop {0}. Celengan, stiker, dan tagihan berulang tetap aman.':'Clears {0} logs and envelopes. Funds, stickers and recurring bills stay untouched.',
  'Reset Total':'Factory Reset',
  'Hapus semua: catatan, celengan, stiker, washi, tagihan, dan pengaturan.':'Erases everything: logs, funds, stickers, washi, bills and settings.',
  'Yakin reset {0}? 🥺':'Reset {0}? 🥺',
  'Catatan jajan dan amplop bulan ini bakal hilang. Celenganmu tetap utuh.':'This month’s logs and envelopes will be gone. Your funds stay intact.',
  'Iya, reset bulan ini':'Yes, reset this month',
  'Bulan {0} udah dikosongkan 🌱':'{0} has been cleared 🌱',
